...
class IHM:
    ...
    def update_textes(self):
        self.textes = [["Positionnement de l'Antenne",WHITE, self.big,0,10],
                        ["Azimuth de la parabole : " + str(int(self.azimPara)),WHITE, self.small,-170,50],
                        ["Elevation de la parabole : " + str(int(self.elevPara)),WHITE, self.small,-165,80],
                        ["Latitude :"+ str(int(self.lat)), WHITE, self.small,-185,110],
                        ["Longitude :"+ str(int(self.longi)),WHITE, self.small,-180,140]]
...
def GPS():
	gps = serial.Serial('/dev/ttyUSB0', 4800)#configuration du port serie avec un bauderate 4800
