    ...
    def __init__(self, rotorSerial, verinSerial):
        if rotorSerial is not None:
            if verinSerial is not None:
                ...
                self.angleRotor = 0
                self.finAlgo = 0
                print("Démarage de l'asservissement'")
            else:
                self.algo = None
...
class IHM:
    ...
    def __init__(self):
        self.screen = pygame.display.set_mode((720,480))#,pygame.FULLSCREEN)
        self.loop = True
        ...
        self.create_fond()
        self.create_button()
        azimPara, elevPara, lat, longi = 1,2,3,4#GPS()
    ...
    def update_textes(self):
        ...
        self.textes = [["Positionnement de l'Antenne",WHITE, self.big,0,15,True],
                        ...
                        ["Nord magnétique : "+angleIHM,WHITE,self.small,200,200,True],
                        ["Mettez le rotor à 0°",WHITE, self.big,0,100,False]]
    ...
    def create_fond(self):
        ...
        self.fond.fill(GREY)
    def image(self):
        # strategic = pygame.image.load("/home/pi/Desktop/Projet-2018-2019-Parabole/Programmation/Raspberry/StrategicTelecom.png").convert_alpha()
        ...
        while self.loop:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    self.rotor_horaire.update_button(self.fond, action=actionVide )
                    self.rotor_antihoraire.update_button(self.fond, action=actionVide  )
...
def saisie(para):
    ...
    for i in garder:
        angleIHM += i
    print(angleIHM)
    Larcay.textes[5][0] = "Nord magnétique : "+angleIHM
    return garder
...
def valider():
    if(Larcay.textes[6][0]=="Mettez le rotor à 0°"):

        Larcay.textes[6][0]="Mettez le rotor à 360°"
    else:
        ...
        Larcay.textes[6][0]="Mettez le rotor à 0°"
